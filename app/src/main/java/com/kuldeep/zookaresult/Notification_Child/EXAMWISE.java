 ...
 */
public class EXAMWISE extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    public WebView mWebView;
    private SwipeRefreshLayout swipeRefreshLayout;
    public static EXAMWISE newInstance(int position) {
        EXAMWISE fragment = new EXAMWISE();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView.loadUrl("https://zookaresult.in/app/examwise-notification/");
